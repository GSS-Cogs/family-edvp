...
df = df.replace({'Breakdown' : {'excluding-net-emissions-removals-from-land-use-land-use-change-and-forestry-lulucf' : 'excluding-net-emissions-removals-from-lulucf'}})
